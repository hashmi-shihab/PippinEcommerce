            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="product-card">
                        <div class="product-card-img">
                            ...
                            <img src="{{url('image/image1.jpg')}}" alt="Laptop">
                        </div>
                ...
                <div class="col-md-3">
                    <div class="product-card">
                        <div class="product-card-img">
                            <label class="stock bg-success">In Stock</label>
                            <img src="{{url('image/image1.jpg')}}" alt="Red MI Note 8">
                        </div>
                        <div class="product-card-body">
                ...
                <div class="col-md-3">
                    <div class="product-card">
                        <div class="product-card-img">
                            <label class="stock bg-success">In Stock</label>
                            <img src="{{url('image/image1.jpg')}}" alt="Mens Shirt">
                        </div>
                        <div class="product-card-body">
                ...
                <div class="col-md-3">
                    <div class="product-card">
                        <div class="product-card-img">
                            <label class="stock bg-success">In Stock</label>
                            <img src="{{url('image/image1.jpg')}}" alt="Head Phone">
                        </div>
                        <div class="product-card-body">
